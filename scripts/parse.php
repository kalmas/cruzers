<?php
/**
 * Parses raw file generated by OCR program.
 * Attempts to generate pipe seperated records like `id|name|artist`
 */

$originalFile = $dataDir . "songbook/cruzers_songlist/allpagesraw.txt";
$strippedFile = $dataDir . "tmp/parsed/1";
$parsedFile = $dataDir . "tmp/parsed/2.csv";
